<div class="tableActions">
    <a class="btn" href="{{route('admin.menu_items.edit', ['menu_item' => $instance->id])}}">
        <span class="svg-icon">
    ...
    <a class="svg-icon" data-kt-docs-table-filter="delete_row" data-action="{{route('admin.menu_items.destroy', ['menu_item'=> $instance->id])}}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.menu_items.destroy', ['menu_item'=> $instance->id])}}" xmlns="http://www.w3.org/2000/svg"
