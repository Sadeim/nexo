<div class="tableActions">
    <a class="btn" href="{{route('admin.attributes.show', ['attribute' => $instance->id])}}">
        <span class="svg-icon">
    ...
    <a class="btn" href="{{route('admin.attributes.edit', ['attribute' => $instance->id])}}">
        <span class="svg-icon">
    ...
    <a class="btn" data-kt-docs-table-filter="delete_row" data-action="{{route('admin.attributes.destroy', ['attribute'=> $instance->id])}}">
        <span class="svg-icon">
            <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.attributes.destroy', ['attribute'=> $instance->id])}}" xmlns="http://www.w3.org/2000/svg"
