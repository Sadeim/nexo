<div class="tableActions">
    <a class="btn" href="{{ route('admin.accounts.edit', ['account' => $instance->id]) }}" title="Edit" data-bs-toggle="tooltip">
        <span class="svg-icon">
    ...
    <a class="svg-icon" data-kt-docs-table-filter="delete_row" data-action="{{ route('admin.accounts.destroy', ['account' => $instance->id]) }}" title="Delete" data-bs-toggle="tooltip">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{ route('admin.accounts.destroy', ['account' => $instance->id]) }}" xmlns="http://www.w3.org/2000/svg"
