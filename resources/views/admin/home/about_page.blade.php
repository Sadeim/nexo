@extends('admin.layouts.master', ['is_active_parent' => 'about', 'is_active' => 'about'])
@section('title')
    About page
@endsection
@section('content')
...
@push('scripts')
    <script>
        ...
        saveBtn?.addEventListener('click', () => {
            ...
            if (!formData.has('title') && !formData.has('description') && !formData.has('note') && !formData.has(
                    'image')) {
            ...
            fetch(url, {
                ...
                .then(data => {
                    if (data.success) {
                        if (titleInput) {
                            document.getElementById('sectionTitleText').textContent = 'Title: ' + (titleInput
                                .value.trim() || 'N/A');
                        ...
                        if (descriptionInput) {
                            document.getElementById('sectionDescriptionText').textContent = descriptionInput
                                .value.trim() || 'N/A';
                        ...
                        if (noteInput) {
                            document.getElementById('sectionNoteText').textContent = noteInput.value.trim() ||
                                'N/A';
