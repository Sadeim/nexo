<div class="tableActions">
    <a class="btn" href="{{ route('admin.employees.edit', ['employee' => $instance->id]) }}" title="Edit" data-bs-toggle="tooltip">
        <span class="svg-icon">
    ...
    <a class="svg-icon" data-kt-docs-table-filter="delete_row"
       data-action="{{ route('admin.employees.destroy', ['employee' => $instance->id]) }}"
