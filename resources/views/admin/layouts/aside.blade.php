        ...
        <div class="hover-scroll-overlay-y " id="kt_aside_menu_wrapper" data-kt-scroll="true"
            ...
            <div class="menu aside-toolbar menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
                ...
                <div data-kt-menu-trigger="click"
                    class="menu-item menu-accordion {{ $is_active_parent == 'home' ? 'here show' : '' }}">
                ...
                {{-- @if (auth()->user()->can('view_products'))
                    <div class="menu-sub menu-sub-accordion">
                        <div class="menu-item">
                            <a class="menu-link {{ $is_active == 'products' ? 'active' : '' }}"
                                href="{{ route('admin.products.index') }}">
                                <span class="menu-bullet">
                                    <i class="fa-solid fa-layer-group"></i>
                                </span>
                                <span class="menu-title">{{ __('admin.global.products') }}</span>
                            </a>
                        </div>
                    </div>
                @endif --}}
                ...
                @if (auth()->user()->hasRole('admin'))
                    ...
                    <div class="menu-item">
                        <a class="menu-link {{ $is_active == 'pos_settings' ? 'active' : '' }}"
                            href="{{ route('admin.pos_settings.index') }}">
                            <span class="menu-icon">
                                <span class="svg-icon svg-icon-2">
                                    <i class="fa-solid fa-sliders"></i>
                                </span>
