<div class="tableActions">
    ...
    <a class="svg-icon" data-kt-docs-table-filter="delete_row" data-action="{{route('admin.blogs.destroy', ['blog'=> $instance->id])}}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.blogs.destroy', ['blog'=> $instance->id])}}" xmlns="http://www.w3.org/2000/svg"
