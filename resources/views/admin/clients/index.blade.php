                    ...
                    <div class="page-content-header">
                        <div class="row justify-content-between">
                            <div class="col-3 col-sm-12 col-md-3 col-lg-3">
                                <h2 class="table-title">{{ __('admin.global.clients') }}</h2>
                            ...
                            <div class="col-8 col-sm-12 col-md-9 col-lg-9">
                                <div class="card-toolbar flex-row-fluid d-flex justify-content-end gap-5">
                                    ...
                                    <a class="btn btn-primary" href="{{ route('admin.clients.create') }}">
                                        {{ __('admin.global.add_new_client') }}
...
@push('scripts')
    <script>
        window.datatable_url = "{{ route('admin.clients.datatable') }}";
    </script>
    <script src="{{ asset('admin_assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
    <script src="{{ asset('admin_assets/js_resources/clients.js') }}"></script>
