@extends('admin.layouts.master', ['is_active_parent' => 'home', 'is_active' => 'products'])
@section('title')
    ...
    <form id="kt_form" class="form row d-flex flex-column flex-lg-row addForm"
        ...
        @isset($product)
            ...
            <div class="page-content-header mb-5">
                <h2 class="table-title">{{ __('admin.global.add_new_product') }}</h2>
            </div>
                        ...
                        <div class="card-toolbar">
                            <div class="image-input image-input-outline image-input-placeholder image-input-empty"
                                ...
                                <div class="image-input-wrapper w-200px h-200px"
                                    style="background-image: url(@if (isset($product) && $product->image !== null) {{ asset($product->image) }} @else {{ asset('admin_assets/media/svg/files/blank-image.svg') }} @endif)">
                                </div>
                                    ...
                                    <div class="col-md-12 fv-row fv-plugins-icon-container">
                                        <div class="mb-5 fv-row">
                                            ...
                                            <input type="number" name="price" id="price" step="0.01"
                                                class="form-control mb-2" placeholder="{{ __('admin.global.product_price') }}"
