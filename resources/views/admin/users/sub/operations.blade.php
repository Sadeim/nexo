<div class="tableActions">
    <a class="btn" href="{{route('admin.users.edit', ['user' => $instance->id])}}">
        <span class="svg-icon">
    ...
    <a class="svg-icon" data-kt-docs-table-filter="delete_row" data-action="{{route('admin.users.destroy', ['user'=> $instance->id])}}" data-name="{{ $instance->name }}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.users.destroy', ['user'=> $instance->id])}}" data-name="{{ $instance->name }}" xmlns="http://www.w3.org/2000/svg"
