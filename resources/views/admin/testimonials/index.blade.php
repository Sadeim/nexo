@extends('admin.layouts.master', ['is_active_parent' => 'home','is_active'=> 'testimonials'])
@section('title')
    {{ __('admin.global.testimonials') }}
@endsection
@section('content')
@if ($section)
    ...
    <div class="card card-flush mb-5" id="sectionCard">
        <div class="card-header d-flex justify-content-between align-items-center">
            ...
            <div class="d-flex align-items-center gap-4">
                ...
                <!-- Edit/Save Buttons -->
                <button class="btn btn-primary" id="editBtn" disabled>
                    ...
                    <div class="page-content-header">
                        <div class="row justify-content-between">
                            <div class="col-3 col-sm-12 col-md-3 col-lg-3">
                                <h2 class="table-title">{{ __('admin.global.testimonials') }}</h2>
                            ...
                            <div class="col-8 col-sm-12 col-md-9 col-lg-9">
                                <div class="card-toolbar flex-row-fluid d-flex justify-content-end gap-5">
                                    ...
                                    <a class="btn btn-primary" href="{{ route('admin.testimonials.create') }}">
                                        {{ __('admin.global.add_new_testimonial') }}
...
@push('scripts')
    <script>
        window.datatable_url = "{{ route('admin.testimonials.datatable') }}";
    </script>
    <script src="{{ asset('admin_assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
    <script src="{{ asset('admin_assets/js_resources/testimonials.js') }}"></script>
