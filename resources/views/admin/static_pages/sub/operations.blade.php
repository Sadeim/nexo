<div class="tableActions">
    <a class="btn" href="{{route('admin.static_pages.edit', ['static_page' => $instance->id])}}">
        <span class="svg-icon">
    ...
    <a class="svg-icon" data-kt-docs-table-filter="delete_row" data-action="{{route('admin.static_pages.destroy', ['static_page'=> $instance->id])}}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.static_pages.destroy', ['static_page'=> $instance->id])}}" xmlns="http://www.w3.org/2000/svg"
