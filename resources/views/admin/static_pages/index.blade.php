...
@push('scripts')
    <script>
        window.datatable_url = "{{ route('admin.static_pages.datatable') }}";
    </script>
    <script src="{{ asset('admin_assets/plugins/custom/datatables/datatables.bundle.js') }}"></script>
    <script src="{{ asset('admin_assets/js_resources/static_pages.js') }}"></script>
