                        ...
                        <div class="card card-custom card-stretch gutter-b">
                            <div class="card card-custom">
                                <div class="card">
                                    ...
                                    <form id="kt_form" class="form fv-plugins-bootstrap5 fv-plugins-framework"
                                        action="{{ route('admin.settings.update') }}" method="POST"
                                        data-kt-redirect="{{ route('admin.settings.index') }}" enctype='multipart/form-data'
                                        novalidate="novalidate">
                                        @csrf
                                        <div class="card-body p-9">
                                            <div class="row mb-5">
                                                <div class="col-xl-3">
                                                    <div class="fs-6 fw-semibold mt-2 mb-3">Browser Icon</div>
                                                </div>
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="image-input image-input-outline" data-kt-image-input="true"
                                                        ...
                                                        <div class="image-input-wrapper w-125px h-125px bgi-position-center"
                                                            style="background-size: 75%; background-image: url({{ $settings->valueOf('browser_icon') !== null ? $settings->valueOf('browser_icon') : asset('admin_assets/media/svg/brand-logos/volicity-9.svg') }})">
                                                        </div>
                                                        <label
                                            ...
                                            <div class="row mb-5">
                                                ...
                                                <div class="col-lg-8">
                                                    <div class="image-input image-input-outline" data-kt-image-input="true"
                                                        style="background-image: url('assets/media/svg/files/blank-image.svg')">
                                                        <div class="image-input-wrapper w-125px h-125px bgi-position-center"
                                                            style="background-size: 75%; background-image: url({{ $settings->valueOf('company_logo_footer') !== null ? $settings->valueOf('company_logo_footer') : asset('admin_assets/media/svg/brand-logos/volicity-9.svg') }})">
                                                        </div>
                                                        <label
                                                            class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                                                            data-kt-image-input-action="change" data-bs-toggle="tooltip"
                                                            data-kt-initialized="1">
                                                            <i class="bi bi-pencil-fill fs-7"></i>
                                                            <input type="file" name="company_logo_footer"
                                                                accept=".png, .jpg, .jpeg">
                                                        </label>
                                                        <span
                                                            class="btn btn-icon btn-circle btn-active-color-primary w-25px h-25px bg-white shadow"
                                            ...
                                            <div class="row mb-8">
                                                ...
                                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                    <input type="text" class="form-control" name="site_title"
                                                        value="{{ $settings->valueOf('site_title') }}">
                                            ...
                                            <div class="row mb-8">
                                                ...
                                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                    <input type="text" class="form-control" name="whatsapp"
                                                        value="{{ $settings->valueOf('whatsapp') }}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            {{-- <div class="row mb-8">
                                            ...
                                            <div class="row mb-8">
                                                ...
                                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                    <input type="text" class="form-control" name="facebook"
                                                        value="{{ $settings->valueOf('facebook') }}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="row mb-8">
                                                ...
                                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                    <input type="text" class="form-control" name="instagram"
                                                        value="{{ $settings->valueOf('instagram') }}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="row mb-8">
                                                ...
                                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                    <input type="text" class="form-control" name="twitter"
                                                        value="{{ $settings->valueOf('twitter') }}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="row mb-8">
                                                ...
                                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                    <input type="text" class="form-control" name="address"
                                                        value="{{ $settings->valueOf('address') }}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            {{-- <div class="row mb-8">
                                            ...
                                            <div class="row mb-8">
                                                ...
                                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                    <input type="text" class="form-control" name="web_address"
                                                        value="{{ $settings->valueOf('web_address') }}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="row mb-8">
                                                ...
                                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                    <input type="text" class="form-control" name="site_description"
                                                        value="{{ $settings->valueOf('site_description') }}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="row mb-8">
                                                <div class="col-xl-3">
                                                    <div class="fs-6 fw-semibold mt-2 mb-3">Top Header Description</div>
                                                </div>
                                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                    <input type="text" class="form-control"
                                                        name="top_header_description"
                                                        value="{{ $settings->valueOf('top_header_description') }}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="row mb-8">
                                                <div class="col-xl-3">
                                                    <div class="fs-6 fw-semibold mt-2 mb-3">Working hours 1</div>
                                                </div>
                                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                    <input type="text" class="form-control" name="hours_part1"
                                                        value="{{ $settings->valueOf('hours_part1') }}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            <div class="row mb-8">
                                                <div class="col-xl-3">
                                                    <div class="fs-6 fw-semibold mt-2 mb-3">Working hours 2</div>
                                                </div>
                                                <div class="col-xl-9 fv-row fv-plugins-icon-container">
                                                    <input type="text" class="form-control" name="hours_part2"
                                                        value="{{ $settings->valueOf('hours_part2') }}">
                                                    <div class="fv-plugins-message-container invalid-feedback"></div>
                                                </div>
                                            </div>
                                            {{-- <div class="row mb-8">
                                        ...
                                        <div class="card-footer d-flex justify-content-end py-6 px-9">
                                            <button type="reset"
                                                class="btn btn-light btn-active-light-primary me-2">Cancel</button>
