<div class="tableActions">
    <a class="btn" href="{{route('admin.roles.edit', ['role' => $instance->id])}}">
        <span class="svg-icon">
    ...
    <a class="btn svg-icon" data-kt-docs-table-filter="delete_row" data-name="{{ $instance->name }}" data-action="{{route('admin.roles.destroy', ['role'=> $instance->id])}}">
        <svg data-kt-docs-table-filter="delete_row" data-action="{{route('admin.roles.destroy', ['role'=> $instance->id])}}" xmlns="http://www.w3.org/2000/svg"
